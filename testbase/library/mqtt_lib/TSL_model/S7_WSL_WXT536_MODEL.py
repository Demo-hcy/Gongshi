...
class S7_WSL_WXT536(Device):
    def __init__(self, deviceId: str) -> None:
        super().__init__(deviceId)
        self.productId = 'S7_WSL_WXT536'
        self.productName = '维萨拉WXT536'
...
class Properties:
    def __init__(self) -> None:
        ...
        self.tempreture = TempretureProperty()
        ...
        self.precipitationPeak = PrecipitationPeakProperty()
        self.precipitationIntensity = PrecipitationIntensityProperty()
        self.rainingTime = RainingTimeProperty()
    ...
    @property
    def v(self):
        return {'mode': self.mode.v, 'model': self.model.v, 'airPressure': self.airPressure.v, 'tempreture': self.tempreture.v, 'humidity': self.humidity.v, 'windDirection': self.windDirection.v, 'minWindDirection': self.minWindDirection.v, 'maxWindDirection': self.maxWindDirection.v, 'minWindSpeed': self.minWindSpeed.v, 'windSpeed': self.windSpeed.v, 'maxWindSpeed': self.maxWindSpeed.v, 'precipitation': self.precipitation.v, 'precipitationPeak': self.precipitationPeak.v, 'precipitationIntensity': self.precipitationIntensity.v, 'rainingTime': self.rainingTime.v, 'rs485Port': self.rs485Port.v, 'rs485Baund': self.rs485Baund.v, 'rs485DataBit': self.rs485DataBit.v, 'rs485Parity': self.rs485Parity.v, 'rs485StopBit': self.rs485StopBit.v, 'online': self.online.v, 'sn': self.sn.v}
    ...
    def v(self, value):
        ...
        if value.get('tempreture') is not None: self.tempreture.v = value['tempreture']
        ...
        if value.get('precipitationPeak') is not None: self.precipitationPeak.v = value['precipitationPeak']
        if value.get('precipitationIntensity') is not None: self.precipitationIntensity.v = value['precipitationIntensity']
        if value.get('rainingTime') is not None: self.rainingTime.v = value['rainingTime']
...
class RainingTimeProperty(BaseProperty):
    def __init__(self, id=None, name=None, accessMode=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, accessMode, type, required, specs)
        self.id = 'rainingTime'
        self.name = '降雨持续时间'
        ...
        self.required = True
        self.type = 'integer'
        self.specs = RainingTimePropertySpecs()
        self.v: int = 0


class RainingTimePropertySpecs(BaseSpecs):
    def __init__(self, min=None, max=None, unit=None, unitName=None, step=None, optional=None) -> None:
        super().__init__(min, max, unit, unitName, step, optional)
        self.min = 0
        self.max = 6553500
...
class PrecipitationIntensityProperty(BaseProperty):
    def __init__(self, id=None, name=None, accessMode=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, accessMode, type, required, specs)
        self.id = 'precipitationIntensity'
        self.name = '降雨强度'
        self.accessMode = 'ro'
        self.required = True
        self.type = 'number'
        self.specs = PrecipitationIntensityPropertySpecs()
        self.v: float = 0.0


class PrecipitationIntensityPropertySpecs(BaseSpecs):
    def __init__(self, min=None, max=None, unit=None, unitName=None, step=None, optional=None) -> None:
        super().__init__(min, max, unit, unitName, step, optional)
        self.min = 0
        self.max = 60
...
class PrecipitationPeakProperty(BaseProperty):
    def __init__(self, id=None, name=None, accessMode=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, accessMode, type, required, specs)
        self.id = 'precipitationPeak'
        self.name = '降雨峰值'
        self.accessMode = 'ro'
        self.required = True
        self.type = 'number'
        self.specs = PrecipitationPeakPropertySpecs()
        self.v: float = 0.0


class PrecipitationPeakPropertySpecs(BaseSpecs):
    def __init__(self, min=None, max=None, unit=None, unitName=None, step=None, optional=None) -> None:
        super().__init__(min, max, unit, unitName, step, optional)
        self.min = 0
        self.max = 200
...
class TempretureProperty(BaseProperty):
    def __init__(self, id=None, name=None, accessMode=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, accessMode, type, required, specs)
        self.id = 'tempreture'
        self.name = '温度'
        ...
        self.required = True
        self.type = 'number'
        self.specs = TempreturePropertySpecs()
        self.v: float = 0.0


class TempreturePropertySpecs(BaseSpecs):
    def __init__(self, min=None, max=None, unit=None, unitName=None, step=None, optional=None) -> None:
        super().__init__(min, max, unit, unitName, step, optional)
        self.min = -52
        self.max = 62
