...
class YTiltAlarmEvent(BaseEvent):
    def __init__(self, id=None, name=None, parameters=None) -> None:
        ...
        self.id = 'yTiltAlarm'
        self.name = 'Y轴倾斜告警'
        self.parameters = YTiltAlarmEventParameters()


class YTiltAlarmEventParameters:
    def __init__(self) -> None:
        self.yAngle = YAngleYTiltAlarmEventParameter()

    @property
    def v(self):
        return {'yAngle': self.yAngle.v}
...
class YAngleYTiltAlarmEventParameter(BaseParameter):
    def __init__(self, id=None, name=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, type, required, specs)
        self.id = 'yAngle'
        self.name = 'Y轴倾斜值'
        self.required = True
        self.type = 'number'
        self.specs = YAngleYTiltAlarmEventParameterSpecs()
        self.v: float = 0.0


class YAngleYTiltAlarmEventParameterSpecs(BaseSpecs):
    def __init__(self, min=None, max=None, unit=None, unitName=None, step=None, optional=None) -> None:
        super().__init__(min, max, unit, unitName, step, optional)
        self.min = -45
        self.max = 45
...
class XTiltAlarmEvent(BaseEvent):
    def __init__(self, id=None, name=None, parameters=None) -> None:
        ...
        self.id = 'xTiltAlarm'
        self.name = 'X轴倾斜告警'
        self.parameters = XTiltAlarmEventParameters()


class XTiltAlarmEventParameters:
    def __init__(self) -> None:
        self.xAngle = XAngleXTiltAlarmEventParameter()

    @property
    def v(self):
        return {'xAngle': self.xAngle.v}
...
class XAngleXTiltAlarmEventParameter(BaseParameter):
    def __init__(self, id=None, name=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, type, required, specs)
        self.id = 'xAngle'
        self.name = 'X轴倾斜值'
        self.required = True
        self.type = 'number'
        self.specs = XAngleXTiltAlarmEventParameterSpecs()
        self.v: float = 0.0


class XAngleXTiltAlarmEventParameterSpecs(BaseSpecs):
    def __init__(self, min=None, max=None, unit=None, unitName=None, step=None, optional=None) -> None:
        super().__init__(min, max, unit, unitName, step, optional)
        self.min = -45
        self.max = 45
...
class Properties:
    ...
    @property
    def v(self):
        return {'xAngle': self.xAngle.v, 'model': self.model.v, 'yAngle': self.yAngle.v, 'xAngleThreshold': self.xAngleThreshold.v, 'yAngleThreshold': self.yAngleThreshold.v, 'rs485Port': self.rs485Port.v, 'rs485Addr': self.rs485Addr.v, 'rs485Baund': self.rs485Baund.v, 'rs485DataBit': self.rs485DataBit.v, 'rs485Parity': self.rs485Parity.v, 'rs485StopBit': self.rs485StopBit.v, 'online': self.online.v, 'mode': self.mode.v, 'sn': self.sn.v, 'alarmInterval': self.alarmInterval.v}
