...
class S8_RLY_RUILONJGS869(Device):
    def __init__(self, deviceId: str) -> None:
        super().__init__(deviceId)
        self.productId = 'S8_RLY_RUILONJGS869'
...
class Properties:
    ...
    @property
    def v(self):
        return {'onOff': self.onOff.v, 'online': self.online.v, 'model': self.model.v, 'version': self.version.v, 'rs485Port': self.rs485Port.v, 'rs485Addr': self.rs485Addr.v, 'rs485Baund': self.rs485Baund.v, 'rs485DataBit': self.rs485DataBit.v, 'rs485Parity': self.rs485Parity.v, 'rs485StopBit': self.rs485StopBit.v, 'sn': self.sn.v, 'mode': self.mode.v}
