...
class S7_FRT_RDM306(Device):
    def __init__(self, deviceId: str) -> None:
        super().__init__(deviceId)
        self.productId = 'S7_FRT_RDM306'
        self.productName = '富奥通306'
