...
class DH_001(Device):
    def __init__(self, deviceId: str) -> None:
        ...
        self.productId = 'DH_001'
        self.productName = '动环智能网关'
