...
class S7_RK_RSWSN012(Device):
    def __init__(self, deviceId: str) -> None:
        super().__init__(deviceId)
        self.productId = 'S7_RK_RSWSN012'
        self.productName = '建大仁科温湿度传感器'
