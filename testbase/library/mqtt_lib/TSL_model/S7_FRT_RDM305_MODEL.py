...
class S7_FRT_RDM305(Device):
    def __init__(self, deviceId: str) -> None:
        super().__init__(deviceId)
        self.productId = 'S7_FRT_RDM305'
        self.productName = '富奥通305'
...
class Properties:
    ...
    @property
    def v(self):
        return {'minWindDirection': self.minWindDirection.v, 'model': self.model.v, 'mode': self.mode.v, 'windDirection': self.windDirection.v, 'maxWindDirection': self.maxWindDirection.v, 'airPressure': self.airPressure.v, 'temperature': self.temperature.v, 'humidity': self.humidity.v, 'noise': self.noise.v, 'minWindSpeed': self.minWindSpeed.v, 'windSpeed': self.windSpeed.v, 'maxWindSpeed': self.maxWindSpeed.v, 'PM2_5': self.PM2_5.v, 'PM10': self.PM10.v, 'rs485Port': self.rs485Port.v, 'rs485Addr': self.rs485Addr.v, 'rs485Baund': self.rs485Baund.v, 'rs485DataBit': self.rs485DataBit.v, 'rs485Parity': self.rs485Parity.v, 'rs485StopBit': self.rs485StopBit.v, 'online': self.online.v, 'sn': self.sn.v}
