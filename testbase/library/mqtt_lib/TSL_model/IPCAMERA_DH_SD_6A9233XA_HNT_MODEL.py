...
class DH_SD_6A9233XA_HNT(Device):
    def __init__(self, deviceId: str) -> None:
        super().__init__(deviceId)
        self.productId = 'DH-SD-6A9233XA-HNT'
        self.productName = '网络摄像机'
...
class SetOnvifAlarmServiceParameters:
    def __init__(self) -> None:
        ...
        self.alarmList = AlarmListSetOnvifAlarmServiceParameter()
        self.enable = EnableSetOnvifAlarmServiceParameter()

    @property
    def v(self):
        return {'channel': self.channel.v, 'alarmList': self.alarmList.v, 'enable': self.enable.v}
...
class AlarmListSetOnvifAlarmServiceParameter(BaseParameter):
    def __init__(self, id=None, name=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, type, required, specs)
        self.id = 'alarmList'
        self.name = '告警类型列表'
        self.type = 'array'
        self.required = True
        self.columnSimple = [AlarmListSetOnvifAlarmServiceParameterColumnSimpleStruct()]
    ...
    def v(self, value):
        self.columnSimple = []
        for val in value:
            x = AlarmListSetOnvifAlarmServiceParameterColumnSimpleStruct()
            x.v = val
            self.columnSimple.append(x)


class AlarmListSetOnvifAlarmServiceParameterColumnSimpleStruct:
    def __init__(self) -> None:
        self.type = 'integer'
        self.v: int = 0
...
class GetVideoStreamService(BaseService):
    def __init__(self, id=None, name=None, parameters=None, outputs=None) -> None:
        ...
        self.outputs = GetVideoStreamServiceOutputs()


class GetVideoStreamServiceOutputs:
    def __init__(self) -> None:
...
class GetPresetsService(BaseService):
    def __init__(self, id=None, name=None, parameters=None, outputs=None) -> None:
        ...
        self.outputs = GetPresetsServiceOutputs()


class GetPresetsServiceOutputs:
    def __init__(self) -> None:
...
class SetPresetService(BaseService):
    def __init__(self, id=None, name=None, parameters=None, outputs=None) -> None:
        ...
        self.outputs = SetPresetServiceOutputs()


class SetPresetServiceOutputs:
    def __init__(self) -> None:
...
class RefreshVideoResolutionService(BaseService):
    def __init__(self, id=None, name=None, parameters=None, outputs=None) -> None:
        ...
        self.outputs = RefreshVideoResolutionServiceOutputs()


class RefreshVideoResolutionServiceOutputs:
    def __init__(self) -> None:
...
class Id5Event(BaseEvent):
    def __init__(self, id=None, name=None, parameters=None) -> None:
        super().__init__(id, name, parameters)
        self.id = '5'
        self.name = '摄像机告警事件'
        self.parameters = Id5EventParameters()


class Id5EventParameters:
    def __init__(self) -> None:
        self.subType = SubTypeId5EventParameter()
        self.process = ProcessId5EventParameter()

    @property
    def v(self):
        return {'subType': self.subType.v, 'process': self.process.v}

    @v.setter
    def v(self, value):
        if value.get('subType') is not None: self.subType.v = value['subType']
        if value.get('process') is not None: self.process.v = value['process']


class ProcessId5EventParameter(BaseParameter):
    def __init__(self, id=None, name=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, type, required, specs)
        self.id = 'process'
        self.name = '告警开始/结束'
        self.type = 'integer'
        self.specs = ProcessId5EventParameterSpecs()
        self.v: int = 0


class ProcessId5EventParameterSpecs(BaseSpecs):
    def __init__(self, min=None, max=None, unit=None, unitName=None, step=None, optional=None) -> None:
        super().__init__(min, max, unit, unitName, step, optional)
        self.optional = ProcessId5EventParameterSpecsOptional()


class ProcessId5EventParameterSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value1 = Value1ProcessId5EventParameterSpecsOptional()
        self.value0 = Value0ProcessId5EventParameterSpecsOptional()


class Value0ProcessId5EventParameterSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 0
        self.desc = '告警结束'
...
class Value1ProcessId5EventParameterSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 1
        self.desc = '告警开始'
...
class SubTypeId5EventParameter(BaseParameter):
    def __init__(self, id=None, name=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, type, required, specs)
        self.id = 'subType'
        self.name = '摄像机告警子类型'
        self.type = 'integer'
        self.specs = SubTypeId5EventParameterSpecs()
        self.v: int = 0


class SubTypeId5EventParameterSpecs(BaseSpecs):
    def __init__(self, min=None, max=None, unit=None, unitName=None, step=None, optional=None) -> None:
        super().__init__(min, max, unit, unitName, step, optional)
        self.optional = SubTypeId5EventParameterSpecsOptional()


class SubTypeId5EventParameterSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value1 = Value1SubTypeId5EventParameterSpecsOptional()
        self.value2 = Value2SubTypeId5EventParameterSpecsOptional()
        self.value3 = Value3SubTypeId5EventParameterSpecsOptional()
        self.value4 = Value4SubTypeId5EventParameterSpecsOptional()


class Value4SubTypeId5EventParameterSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 4
        self.desc = '遮挡告警'
...
class Value3SubTypeId5EventParameterSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 3
        self.desc = '区域入侵告警'
...
class Value2SubTypeId5EventParameterSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 2
        self.desc = '移动侦测告警'
...
class Value1SubTypeId5EventParameterSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 1
        self.desc = '越界告警'
...
class Properties:
    def __init__(self) -> None:
        ...
        self.IPCSN = IPCSNProperty()
        self.methods = MethodsProperty()
        self.channelCnt = ChannelCntProperty()
        self.channels = ChannelsProperty()

    @property
    def v(self):
        return {'ip': self.ip.v, 'httpPort': self.httpPort.v, 'onvifUser': self.onvifUser.v, 'onvifPassword': self.onvifPassword.v, 'online': self.online.v, 'mode': self.mode.v, 'manufacturer': self.manufacturer.v, 'model': self.model.v, 'IPCSN': self.IPCSN.v, 'methods': self.methods.v, 'channelCnt': self.channelCnt.v, 'channels': self.channels.v}
    ...
    def v(self, value):
        ...
        if value.get('IPCSN') is not None: self.IPCSN.v = value['IPCSN']
        if value.get('methods') is not None: self.methods.v = value['methods']
...
class ChannelsPropertyColumnComplexStruct:
    def __init__(self) -> None:
        ...
        self.methods = MethodsChannelsPropertyColumnComplexStruct()
    ...
    @property
    def v(self):
        return {'id': self.id.v, 'methods': self.methods.v, 'presets': self.presets.v, 'alarmList': self.alarmList.v, 'streamCnt': self.streamCnt.v, 'resolutions': self.resolutions.v}
...
class TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value1 = Value1TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional()
        self.value2 = Value2TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional()
        self.value3 = Value3TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional()
        self.value4 = Value4TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional()


class Value4TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 4
        self.desc = '遮挡告警'
...
class Value3TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 3
        self.desc = '区域入侵告警'
...
class Value2TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 2
        self.desc = '移动侦测告警'
...
class Value1TypeAlarmListChannelsPropertyColumnComplexStructColumnComplexStructSpecsOptional(BaseOptional):
    def __init__(self, value=None, desc=None) -> None:
        super().__init__(value, desc)
        self.value = 1
        self.desc = '越界告警'
...
class MethodsChannelsPropertyColumnComplexStruct:
    def __init__(self) -> None:
        self.id = 'methods'
        self.name = '设备控制方法'
        self.accessMode = 'ro'
        self.required = True
        self.type = 'array'
        self.columnSimple = [MethodsChannelsPropertyColumnComplexStructColumnSimpleStruct()]
    ...
    def v(self, value):
        self.columnSimple = []
        for val in value:
            x = MethodsChannelsPropertyColumnComplexStructColumnSimpleStruct()
            x.v = val
            self.columnSimple.append(x)


class MethodsChannelsPropertyColumnComplexStructColumnSimpleStruct:
    def __init__(self) -> None:
        self.type = 'string'
        self.v: str = ''
...
class MethodsProperty(BaseProperty):
    def __init__(self, id=None, name=None, accessMode=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, accessMode, type, required, specs)
        self.id = 'methods'
        self.name = '设备控制方法'
        ...
        self.required = True
        self.type = 'array'
        self.columnSimple = [MethodsPropertyColumnSimpleStruct()]
    ...
    def v(self, value):
        self.columnSimple = []
        for val in value:
            x = MethodsPropertyColumnSimpleStruct()
            x.v = val
            self.columnSimple.append(x)


class MethodsPropertyColumnSimpleStruct:
    def __init__(self) -> None:
        self.type = 'string'
        self.v: str = ''


class IPCSNProperty(BaseProperty):
    def __init__(self, id=None, name=None, accessMode=None, type=None, required=None, specs=None) -> None:
        super().__init__(id, name, accessMode, type, required, specs)
        self.id = 'IPCSN'
        self.name = '摄像机真实序列号'
